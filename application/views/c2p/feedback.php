...
<H4>Feedback</h4>
<p>This web-site is still being developed, and therefore you may notice things 
    that change or appear to stop working. Your patience and cooperation is 
    appreciated. Any suggestions you make to help this service work more efficiently 
...
<tr>
    ...
    <td align="left" colspan="3"><input name="Name" value="" type="text" size="30" 
        value="<?=(isset($FirstName)?$FirstName:'').' '.(isset($LastName)?$LastName:'');?>" required/></td>
</tr>
<tr>
    <td>Your Email *</td>
    <td align="left" colspan="3">
        <input name="Email" value="" type="email" size="30" 
            value="<?=(isset($Email)?$Email:'');?>" required/></td>  
</tr>
<tr>
    <td>Your Phone</td>
    <td align="left" colspan="3">
...
<tr>
    <td>Subject *</td>
    <td align="left" colspan="3">
         <input name="Subject" value="<?=(isset($Subject)?$Subject:'');?>" type="text" size="30" required/>
    </td>
</tr>
<tr>
    <td valign="top">Message *</td>
    <td align="left" colspan="3">
        <textarea type="text" name="EmailBody" cols="45" rows="10" required>
...
<a href="mailto:admin@connecting2people.net">admin@connecting2people.net</a></p>
</div> <!-- Content -->
