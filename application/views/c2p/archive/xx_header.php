...
-->
      ...
      <!-- C2P Standard -->
        ...
        <link rel="stylesheet" href="../../styles/onewaynew.css<?=date('YmdHis');?>" type="text/css">
    ...
    <div data-role="panel" id="sidemenu" data-display="overlay" data-theme='b' style="display:none">
        <ul data-role="listview" >
            ...
            <DIV data-role="header" class="header">
                <di<div id="sidemenuicon" style="position:relative; top:0px; left:0px;">
                    <a href="#sidemenu"><img alt="hand" src="/application/images/onewaymenuicon.jpg" ></a>
                </div>v style="position:abolute; top:0; float:left;">
                   <img src="/application/images/Transparent_yellowhandR.png" style="height:100;float:top,right;" >
                </div>
                <div id="sidemenuicon" style="position:relative; top:0px; left:0px;">
                    <a href="#sidemenu"><img alt="hand" src="/application/images/onewaymenuicon.jpg" ></a>
                </div>
            ...
            <!--<div class="clear_both"></div>-->
            <div data-role="main" id="navigation-and-content" class="ui-content">
