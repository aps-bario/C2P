<html>
    <head>
        ...
        <meta name="description" content="Helping to connect Chinese students going home"/>
     ...
     <link rel="stylesheet" href="../../styles/onewaynew.css" type="text/css">
        <link rel="stylesheet" href="/application/styles/onewaynew.css" type="text/css">
   <!-- <base href="/">-->
    <link rel="stylesheet" href="../../styles/pack6.css" type="text/css">
    <link rel="stylesheet" href="../../styles/standard.css" type="text/css">
     <link rel="stylesheet" href="../../styles/layout.css" type="text/css">
     <link rel="stylesheet" href="../../styles/site.css" type="text/css">
        <script type="text/javascript" src="../scripts/JQuery.js"></script>
        <script type="text/javascript" src="onewaycss.js"></script>
    </head>
        ...
        <DIV class="paper">
            <DIV class="header">
               <div style="position:abolute; top:0; float:left;">
                   <img src="../../images/Transparent_yellowhandR.png" style="height:100;float:top,right;" >
               </div>
                <div style="position:relative; top:0; float:left;">
                    <H1>ONEWAY</h1>
                    <h2>helping to connect Chinese going home</h2>
                </div>
            </div>
