...
<H4>Your member access level is currently: <b><?=$Status;?></b></h4>
<p>There are various levels of user access in the Connecting2People system. 
   This is in order to keep the system as secure as possible. 
   Before registration visitor access is limited to the Home menu. 
   As various security stages are passed a user progresses up through 
   various levels of membership. There is a brief summary below, 
   but if you need help or clarification please use the Feedback option
   on the Home menu.</p>
<fieldset>
    <legend>Access Level Summary</legend>
<style>
