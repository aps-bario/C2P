...
if(isset($Status) and ($Status=='Registered' or $Status=='Verified'
      ...
      <li class="<?=($NextPage=='member/newreference'?'current-page ':'');?>rendered-link" > 
         <div class="link-content"> 
            <a href="member/newreference" data-page-url="member/newreference"> 
               <div class="title rendered-link-content">New Reference</div> 
               <div class="separator rendered-link-content"></div> 
            </a>
         </div>
      </li>
