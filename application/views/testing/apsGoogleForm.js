/* 
 * Javascript: apsGoogleForm 
 * Program to read, interpret and process Google Form's FB_PUBLIC_LOAD_DATA_ data array
 * Written by Andrew P. Smith
 */


function processForm(GF){
    // GF is a data array structure (FB_PUBLIC_LOAD_DATA_) passed from a Google Form page.
    ...
    $("document").ready(function(e){
        ...
        // Folowing Line added to display title not stored in Google Stricture (perhaps could be in an array also?)
        if(GF1) row+="<H1 class='Title'>"+GF1+"</h1>";
        row=row+"<H2 class='Start'>"+GFH+"</h2>";
        row=row+"<Form id='GF'>";
