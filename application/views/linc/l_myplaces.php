...
$(document).ready(function(){
    ...
    $('#Country').change(function(){
        var QueryString =  'Country='+Country.value;
        loadSelectOptions('Province','GetProvinceOptions',QueryString);
        loadSelectOptions('City','GetCityOptions',QueryString);
    ...
    $('#PlaceID').on('change',function(){    
        loadSelectOptions('Country','GetCountryOptions','PlaceID='+PlaceID.value);         
        loadSelectOptions('Province','GetProvinceOptions','PlaceID='+PlaceID.value);
        loadSelectOptions('City','GetCityOptions','PlaceID='+PlaceID.value);
        loadSelectOptions('Postcode','GetPostcodeOptions','PlaceID='+PlaceID.value);
        loadSelectOptions('District','GetDistrictOptions','PlaceID='+PlaceID.value);
        var QueryString =  'Country='+Country.value+'&Province='+Province.value
           +'&City='+City.value+'&Postcode='+Postcode.value
           +'&District='+District.value+'&PlaceID='+PlaceID.value;
        loadHTML('Update','GetMyPlacesFieldSet','PlaceID='+PlaceID.value);
        $('#Detail').collapsible('expand');
...
function SubmitUpdate(obj){
        var QueryString =  'Country='+obj.form.Country.value+'&Province='+obj.form.Province.value
           +'&City='+obj.form.City.value+'&Postcode='+obj.form.Postcode.value
           +'&District='+obj.form.District.value+'&PlaceID='+obj.form.PlaceID.value
           +'&Returnee='+(obj.form.Returnee.checked?'Y':'N')
           +'&Contact='+(obj.form.Contact.checked?'Y':'N')
           +'&Fellowship='+(obj.form.Fellowship.checked?'Y':'N')
           +'&Church='+(obj.form.Church.checked?'Y':'N')
           +'&Nearby='+(obj.form.Nearby.checked?'Y':'N');
        loadHTML('Message','SetMyPlaceDetails',QueryString);
};
