...
<p><b style="color:red;"><?=(isset($Message)?$Message:'');?>    
    </b></p>
<fieldset><legend>Locations where I know returnees</legend>
NOTE: This page still needs to be reshaped for mobile screens.
<form id="myform" method="post" action="sponsor/myreturnees">
