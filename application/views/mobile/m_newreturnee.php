...
<p>Please provide basic information about the location the returnee is 
   returning to, when that is likely to be and a name (or alias) that a both 
...
a detailed location to which they are returning. Cities are large 
and travelling times long, so it is most helpful to identify an accurate
postcode and administration district.</p>
...
<p>As you narrow your search you will see the number of contacts reduce. This number
   ...
   location.</p><p>As you make each selection other lists will limited and location statistics
    ...
    Grp: Number of fellowship groups known by contacts in area.</small></p> -->
</div>
