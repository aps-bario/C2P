...
<html lang="en">
    <head>
        ...
        <!-- JQuery Standard -->
        <script type="text/javascript" src="/application/scripts/jquery-2.1.1.js?<?=date('YmdHis');?>"></script>
        <!-- JQuery Mobile -->
        <link type="text/css" rel="stylesheet" href="/application/styles/jquery.mobile-1.4.2.css?<?=date('YmdHis');?>">
     <!--   <script type="text/javascript" src="/application/scripts/jquery-1.10.2.min.js?<?=date('YmdHis');?>"></script>
        <script type="text/javascript" src="/application/scripts/jquery.mobile-1.4.2.js?<?=date('YmdHis');?>"></script>-->
        <link type="text/css" rel="stylesheet" href="https://code.jquery.com/mobile/1.4.2/jquery.mobile-1.4.2.min.css?<?=date('YmdHis');?>">
        <script type="text/javascript" src="https://code.jquery.com/jquery-1.10.2.min.js?<?=date('YmdHis');?>"></script>
        <script type="text/javascript" src="https://code.jquery.com/mobile/1.4.2/jquery.mobile-1.4.2.min.js?<?=date('YmdHis');?>"></script>
        <!--<link type="text/css" rel="stylesheet" href="/application/styles/onewaymobile.css?<?=date('YmdHis');?>">-->
    </head>
    <body>
