...
<b>Progress by Location</b>
</div>
<h4>Progress by Location</h4>
<style>
...
</fieldset><fieldset><legend>Furthest Returnee Progress by Location</legend>
<form id="myform" method="post">
   ...
   <table class="report" width="60">
      ...
      <tr height="20px">
         <th style="cursor:pointer;" onclick="ReOrder('Country, Province, City, District');">Country</th>
         <th style="cursor:pointer;" onclick="ReOrder('Province, City');">Province</th>
         <th style="cursor:pointer;" onclick="ReOrder('City, District');">City</th>
        ...
        -->
        <th style="cursor:pointer;" class="vertical" onclick="ReOrder('Returnees');"><b>Returnees</b></th>
...
<?php foreach($results as $row):?>
      <tr>
         ...
         <td nowrap><b><?=$row['Returnees'];?></b></td>
