...
<b>Progress by Gatekeeper</b>
</div>
<h4>Progress by Gatekeeper</h4>
<style>
...
<fieldset><legend>Furthest Returnee Progress by Gatekeeper</legend>
...
<fieldset><legend>All Referral Progress Stages by Gatekeeper</legend>
<form id="myform" method="post">
   <input name="ContactID" type="hidden" value="" />
   <input name="ListOrder" type="hidden" value="<?=(isset($ListOrder)?$ListOrder:'');?>" />
   <input name="PageMode" type="hidden" value="<?=(isset($PageMode)?$PageMode:'');?>" />
