...
<fieldset><legend>List of Referrals to city locations you are watching</legend>
<form id="myform" method="post">
   ...
   <table class="report" width="60">
       <tr><td colspan="6">Below is a list of referrals made to city locations 
          where you have have asked to be notified of such referrals. 
           </td>
      ...
      <tr>
         ...
         <th style="cursor:pointer;" onclick="ReOrder('RespondedDate');">Responded</th>
         <th style="cursor:pointer;" onclick="ReOrder('DeclinedDate');">Declined</th>
         <th style="cursor:pointer;" onclick="ReOrder('AcceptedDate');">Accepted</th>
         <th style="cursor:pointer;" onclick="ReOrder('ConnectedDate');">Connected</th>
         <th style="cursor:pointer;" onclick="ReOrder('ConfirmedDate');">Confirmed</th>
