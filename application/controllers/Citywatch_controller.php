<?php
class citywatch_controller extends CI_Controller {
      ...
      //Check Security
        if(isset($data['Status']) 
         ...
         case 'myplaces':	
            ...
            $data['NextPage'] = 'citywatch/myplaces';
...
//            break;
         ...
         case 'cityreferrals':	
            //$data = $this->Location_model->SelectLocations($data);
            $data = $this->Referral_model->CityReferrals($data); 
            break;
         endswitch;
